...
Runs one low-risk Copilot maintenance task per trusted GitHub repository each Monday. Checks the result, then opens a `maintenance/*` PR with a concise, task-specific title and description generated by Copilot.
...
- empty changes
- missing, malformed, or overly long Copilot-generated PR metadata
